...
# view: order_items_status_country_by_date {
#   derived_table: {
...
#
# }
# view: order_items_status_country_by_month {
#   derived_table: {
#     sql_trigger_value: SELECT CURRENT_DATE ;;
#     explore_source: order_items {
#       column: total_sale_price {}
...
view: order_items_brand_by_date {
  derived_table: {
...
view: order_items_brand_by_month {
  derived_table: {
    persist_for: "24 hours"
    explore_source: order_items {
      column: created_month {}
...
view: order_items_brand_by_year {
  derived_table: {
    persist_for: "24 hours"
    explore_source: order_items {
      column: created_year {}
